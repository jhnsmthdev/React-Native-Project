...
export default StyleSheet.create({
    ...
    emailInput: { height: 60, fontSize: 16, padding: 10, marginTop: 40 },
    passwordInput: { height: 60, fontSize: 16, padding: 10, marginTop: 20 },
    touchableView: { alignItems: "center", marginTop: 35 },
    ...
    socialButtonView: { flexDirection: "row", alignItems: "center", justifyContent: "center", marginTop: 100 },
    ...
    passwordInputAnimated: { marginTop: 10 },
    touchableViewAnimated: { marginTop: 30 }
});